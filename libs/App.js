...
module.exports = new Class({
  ...
  //   if(!this.__forks['__data_formater']){
  //     this.__forks['__data_formater'] = fork(process.cwd()+'/libs/fork', [
  //       path.join(process.cwd(), '/node_modules/node-tabular-data'),
  //       JSON.stringify({
  //         require_path : this.options.libs,
  //         // cache: this.cache,
  //         ID: this.ID
  //       })
  //     ])
  //
  //     this.__forks['__data_formater'].on('message', function(msg){
  //       let data = msg.result
  //       let doc = msg.doc
  //       debug('msg %o %o', data)
  //       cb(data)
  ...
  //   }
  //
  //   this.__forks['__data_formater'].send({
  //     /**
  //     * added false as new param data_formater param (data, format, full, cb)
  //     **/
  //     params: [data, format, full], //process.cwd()+'/apps/stat-changes/libs/data_formater/' -> moved to module param
  //     doc:  Object.clone(data)
  //   })
  //
  // },
